<?php /*a:3:{s:77:"D:\soft\phpstudy_pro\WWW\mall\tp51\application\admin\view\shop_msg\index.html";i:1596720877;s:76:"D:\soft\phpstudy_pro\WWW\mall\tp51\application\admin\view\public\header.html";i:1596722374;s:76:"D:\soft\phpstudy_pro\WWW\mall\tp51\application\admin\view\public\footer.html";i:1596723097;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<form class="layui-form layui-form-pane" action="">
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-inline">
			<input type="text" name="shop_address" value="<?php echo htmlentities($data['shop_address']); ?>" placeholder="请填商店邮箱" autocomplete="off" class="layui-input">
		</div>
    	<div class="layui-form-mid layui-word-aux">空则不显示</div>
	</div>
...
<script src="/static/admin/js/shop_msg.js"></script>
</body>
</html>