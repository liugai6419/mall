...
class GoodsClassify extends Common
{
	...
	public function uploadImg()
	{
		...
		if(isset($file['small_icon'])){

			$info = $file['small_icon']->move(__DIR__.'/../../../public/static/admin/uploads');

		}elseif(isset($file['big_img'])){

			$info = $file['big_img']->move(__DIR__.'/../../../public/static/admin/uploads');
	...
	public function add()
	{
		...
		if(isset($getData["tab"])){
			$data = Db::table("goods_classify")->where("id",$getData["id"])->find();
